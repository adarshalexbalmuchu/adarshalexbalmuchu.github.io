  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 -mt-12">
        ...
        <h1
          className="font-cormorant text-7xl font-light text-white drop-shadow-lg"
        ...
        {/* Tagline */}
        <motion.p
          className="mt-4 text-xl drop-shadow"
        ...
        <motion.a
          href="#chapter-1"
          className="mt-6 inline-block px-8 py-3 rounded-full text-base font-medium tracking-widest uppercase backdrop-blur-sm hover:shadow-[0_0_20px_4px_rgba(236,72,153,0.35)] transition-all duration-300"
          style={{
